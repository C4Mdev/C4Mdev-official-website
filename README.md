...
Submissions are sent **from the browser** to Web3Forms (their recommended setup for the free plan). A server-only variable like `WEB3FORMS_ACCESS_KEY` (without `NEXT_PUBLIC_`) will not be available to the form.
