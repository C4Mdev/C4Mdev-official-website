                    ...
                    <div className="services-details-items">
                        <div className="row">
                            <div className="col-xl-8 col-lg-7 order-lg-last pl-50 pl-md-15 pl-xs-15">
                                ...
                                <p>
                                    We follow a comprehensive software development lifecycle that ensures quality, scalability, and user satisfaction. Our agile methodology allows us to adapt to changing requirements while maintaining project timelines and budgets. From initial concept to final deployment, we work closely with clients to understand their business needs and translate them into powerful software solutions. Our development process includes thorough testing, security audits, and performance optimization to deliver robust applications that drive business growth and operational efficiency.
                                </p>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="item">
                                                ...
                                                <h4><Link href="#" onClick={handleSmoothScroll}>Custom Software Development</Link></h4>
                                                <p>
                                        ...
                                        <div className="col-md-6">
                                            <div className="item">
                                                ...
                                                <h4><Link href="#" onClick={handleSmoothScroll}>System Integration</Link></h4>
                                                <p>
                                                    Seamless integration of new software with existing systems and third-party applications.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-4 col-lg-5 mt-md-120 mt-xs-50 services-sidebar">
                                <div className="single-widget services-list-widget">
                                    <h4 className="widget-title">Software Services</h4>
                                    <div className="content">
                                        <ul>
                                            <li><Link href="#">Custom Development</Link></li>
                                            <li className="current-item"><Link href="#">Web Applications</Link></li>
                                            <li><Link href="#">Mobile Apps</Link></li>
                                            <li><Link href="#">Cloud Solutions</Link></li>
                                            <li><Link href="#">DevOps & CI/CD</Link></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="single-widget bg-dark quick-contact-widget text-light" style={{ backgroundImage: `url(/assets/img/shape/15.png)` }}>
                                    <div className="content">
                                        ...
                                        <p>
                                            Speak with our development team to discuss your project requirements and get a free consultation.
                                        </p>
                                ...
                                <div className="single-widget widget-brochure">
                                    ...
                                    <ul>
                                        <li><Link href="#" onClick={handleSmoothScroll}><i className="fas fa-file-pdf"></i> Download Portfolio </Link></li>
                                        <li><Link href="#" onClick={handleSmoothScroll}><i className="fas fa-file-pdf"></i> Technical Specifications </Link></li>
                                    </ul>
                                </div>
